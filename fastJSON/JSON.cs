...
namespace fastJSON
{
    public class JSON
    {
        ...
        {
            return ToJSON(obj, UseSerializerExtension, UseFastGuid, UseOptimizedDatasetSchema);
        }

        public string ToJSON(object obj, bool enableSerializerExtensions)
        {
            return ToJSON(obj, enableSerializerExtensions, UseFastGuid, UseOptimizedDatasetSchema);
        }

        public string ToJSON(object obj, bool enableSerializerExtensions, bool enableFastGuid)
        {
            return ToJSON(obj, enableSerializerExtensions, enableFastGuid, UseOptimizedDatasetSchema);
        }

        public string ToJSON(object obj, bool enableSerializerExtensions, bool enableFastGuid, bool enableOptimizedDatasetSchema)
        {
            return new JSONSerializer(enableOptimizedDatasetSchema, enableFastGuid, enableSerializerExtensions).ConvertToJSON(obj);
        }
